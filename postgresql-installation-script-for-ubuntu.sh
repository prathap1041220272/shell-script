...
print_last_text() {
	...
	Please Feel Free To File The Issue At $blue link"
	echo "$reset"
	echo ""
	echo "$green $bold Subscribe Our Youtube Channel at $blue link $reset"
	echo ""
...
echo "$reset"
echo ""
echo "To Know More About Using $db_name look at $blue $bold link"
echo "$reset"
echo ""
